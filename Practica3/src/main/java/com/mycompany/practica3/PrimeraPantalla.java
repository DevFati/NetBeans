...
public class PrimeraPantalla extends javax.swing.JFrame {
     ...
     */
    public PrimeraPantalla(Color c) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTextFieldTexto.setBackground(new java.awt.Color(204, 204, 255));
        jTextFieldTexto.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jTextFieldTexto.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        jTextFieldTexto.setText("El color elegido es el: ");
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(117, 117, 117)
                .addComponent(jTextFieldTexto, javax.swing.GroupLayout.PREFERRED_SIZE, 47, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(jButton1)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
         SegundaPantalla newframe=new SegundaPantalla();
    ...
    public void establecerNombre(String nombre){
        jTextFieldTexto.setText("El color elegido es el "+nombre);
    }
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PrimeraPantalla(Color.GRAY).setVisible(true);
            }
        });
    }
