<%-- 
    Document   : registrosEditorial
    Created on : 23-ene-2025, 21:14:56
    Author     : Fatima
--%>
                                        ...
                                        <div>
                                            <form action="EditorialControl" method="post" class="form-horizontal">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" name="nit" value="" placeholder="Código de la editorial" /> 
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-sm-3 control-label no padding-right">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" name="sitioweb" value="" placeholder="Sitioweb" /> 
                                                    </div>
                                                </div>
