                                        ...
                                        <div>
                                            <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><span class="label label-sm label-success"><%= EditorialDao.getEditorial(l.getNitEditorial()) %></span></td>
                                                    <td>
                                                        <span class="label label-sm label-success"><%= CategoriaDao.getCategoria(l.getCodigoCategoria()) %></span>
                                                    </td>
