                                        ...
                                        <div>
                                            <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><%= p.getPrecio() %></td>
                                                    <td><span class="label label-sm label-success"><%= ProveedorDao.getProveedor(p.getProveedorId()) %></span></td>
                                                    <td>
                                                        <span class="label label-sm label-success"><%= CategoriaDao.getCategoria(p.getCategoriaId()) %></span>
                                                    </td>
